...
const About = () => {
  return (
    <div
      id="About"
      className="h-screen w-full flex flex-col md:flex-row justify-center items-center gap-x-12"
    >
      <motion.div
      ...
      >
        <div className="relative w-40 md:w-56 h-40 md:h-96 bg-[#c25051] ml-auto">
          ...
          <h1 className="absolute text-5xl text-txtWhite font-bold -ml-16 mt-4 md:mt-14">
            WHO
            <br />
            AM
            <br />I
